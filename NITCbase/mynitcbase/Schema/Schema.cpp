...
int Schema::renameRel(char oldRelName[ATTR_SIZE], char newRelName[ATTR_SIZE]) {
    ...
    if(!strcmp(oldRelName,"RELATIONCAT") || !strcmp(oldRelName,"ATTRIBUTECAT"))
       return E_NOTPERMITTED;
    
    if(!strcmp(newRelName,"RELATIONCAT") || !strcmp(newRelName,"ATTRIBUTECAT"))
       return E_NOTPERMITTED;
    
    int res = OpenRelTable::getRelId(oldRelName);
