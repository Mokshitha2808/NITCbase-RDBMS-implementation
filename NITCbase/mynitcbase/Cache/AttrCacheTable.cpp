...
{
  strcpy(record[0].sVal,attrCatEntry->relName);
  strcpy(record[1].sVal,attrCatEntry->attrName);
  record[2].nVal = attrCatEntry->attrType;
  record[3].nVal = attrCatEntry->primaryFlag;
  record[4].nVal = attrCatEntry->rootBlock;
  record[5].nVal = attrCatEntry->offset;
}
